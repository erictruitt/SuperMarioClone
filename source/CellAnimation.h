...
public:
	...
	void	Initialize(const wchar_t* _filename, int _rows, int _cols, int _frameWidth, int _frameHeight, int _numFrames, float _duration);	// should have parameters or a config file
	void	Terminate	( void );
